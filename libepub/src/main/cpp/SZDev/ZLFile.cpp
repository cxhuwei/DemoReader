...
int CZLFile::PutFilePath(const char *filepath) {
    ...
    if (anchor != NULL) {
        ...
        memset(m_anchorName, 0, SHORTNAME_LENGTH);//��ֹ�ٸ�ֵ
    ...
    if (m_filePath != NULL) {
        ...
        if (temp) {
            ...
            if (strcmp(temp, m_filePath) == 0) {//�ϴδ򿪹��˾Ͳ��ٴ�
                delete[] temp;
                temp = NULL;
                return 1;
            } else {
...
// 		m_filePath = NULL;
    ...
    //ʹ����ʱ�ļ����浱ǰ·���������ѹ�ɹ��Ÿ���m_filePath�ֶ� myf 20141229
